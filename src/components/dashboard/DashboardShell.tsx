    ...
    <div className="dashboard-shell">
      ...
      <main className="dashboard-content">
        ...
        <div className="dashboard-grid">
          ...
          <div className="side-stack"><section className="memories-panel dashboard-panel"><div className="memories-mark">memories<span>@ Vinhack</span></div><Link className="capture-button" href="/memories"><ImagePlus size={18} /> Capture now <ArrowRight size={18} /></Link></section><section className="countdown-panel dashboard-panel"><div className="panel-title red-title"><span>{"// vinhack live"}</span></div><div className="countdown"><div><strong>22</strong><span>hours</span></div><b>:</b><div><strong>18</strong><span>mins</span></div><b>:</b><div><strong>31</strong><span>secs</span></div></div></section></div>
        </div>
      ...
      {menuOpen && <div className="mobile-drawer" role="dialog" aria-label="Account menu"><button className="drawer-close" onClick={() => setMenuOpen(false)} aria-label="Close account menu"><X /></button><span className="profile-avatar">A</span><strong>Aditya Madan</strong><Link href="/profile" onClick={() => setMenuOpen(false)}><UserRound size={18} /> Profile</Link><Link href="/help" onClick={() => setMenuOpen(false)}><HelpCircle size={18} /> Help center</Link></div>}
    </div>
  );
}