...
export function TimelinePhoto235() {
  return (
...
export function TimelinePhoto234() {
  return (
    <div className="flex-none rotate-[-13.5deg]">
      <div className="relative h-[111.295px] w-[114.013px]" data-name="image 234">
        <img
          alt=""
...
export function TimelineExploreSticker() {
  return (
    <>
      <div className="absolute top-0 left-0 flex h-[166.791px] w-[185.111px] items-center justify-center">
        <div className="flex-none rotate-[-14.05deg] skew-x-[-1.48deg]">
          <div className="relative h-[130.714px] w-[161.483px]" data-name="sticker">
      ...
      <div className="absolute top-[48.11px] left-[37.89px] flex h-[83.826px] w-[123.225px] items-center justify-center">
        <div className="flex-none rotate-15">
          <div className="relative [word-break:break-word] font-rotonto h-[56.669px] leading-[0] not-italic text-[#db9eef] text-[14.753px] tracking-[2.9506px] w-[112.388px] whitespace-pre-wrap">
...
export function TimelinePhoto236() {
  return (
...
export function TimelineVector227() {
  return (
    <div className="flex-none rotate-[-7.91deg]">
      <div className="relative h-[127.496px] w-[133.971px]" data-name="image 227 [Vectorized]">
        <img
          alt=""
...
export function TimelineDay1Stamp() {
  return (
