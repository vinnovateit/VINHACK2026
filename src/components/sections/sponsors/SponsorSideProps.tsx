    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <span className="text-[8.5px] font-rotonto font-semibold tracking-[0.14em] text-[#38bdf8] uppercase">
              VINHACK &apos;26
            </span>
            ...
            <span className="text-[8px] font-rotonto text-white/70 tracking-widest">
              ✦ 30H ✦
            </span>
          </div>
        </div>
      ...
      >
        ...
        <div
          ...
          style={{ boxShadow: "0 1px 2px rgba(0,0,0,0.2)" }}
        />
        <div className="text-center font-rotonto text-[10px] font-semibold tracking-[0.04em] text-[#18181b] leading-[1.35] uppercase">
          THANK YOU FOR
          <br />
          BELIEVING IN
          <br />
