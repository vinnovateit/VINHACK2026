...
export default function RegisterSection() {
  return (
    <section aria-label="Register now" className="-translate-x-1/2 absolute bg-black h-[832px] left-1/2 overflow-clip top-[8512px] w-[1280px]" data-node-id="297:166" data-name="REGISTER NOW">
